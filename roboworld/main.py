...
def threeRightAndUp():
    ...
    anim.save('steps.gif', writer='imagemagick')
...
def randomWalk():
    ...
    anim = world.get_animation()
    anim.save('random-walk.gif', writer='imagemagick')
...
def randomWalkImproved():
    ...
    anim = world.get_animation()
    anim.save('random-walk-improved.gif', writer='imagemagick')
...
def deterministicWalk():
    ...
    anim = world.get_animation()
    anim.save('deterministic-walk.gif', writer='imagemagick')
